...
export declare const MODAL_CONTAINER_CONTENT_CLASSNAME = "web3modal-modal-container-content";
export declare const MODAL_CARD_CLASSNAME = "web3modal-modal-card";
export declare const MODAL_TITLE_CONTAINER_CLASSNAME = "web3modal-modal-title-container";
export declare const MODAL_TITLE_CLASSNAME = "web3modal-modal-title";
export declare const MODAL_SUBTITLE_CLASSNAME = "web3modal-modal-subtitle";
